...
SECRET_KEY = os_environ.get('SECRET_KEY', 'django-insecure-d$-*&$588rqbns7lc9kix*wnh)mr$eeb#&#v4jp!1ndq)m%ax^')
...
# Email settings
EMAIL_BACKEND = os_environ.get('EMAIL_BACKEND', 'django.core.mail.backends.console.EmailBackend')
...
if not DEBUG:
    ...
    if os_environ.get('SECURE_SSL_REDIRECT', '0') == '1':
        ...
        SECURE_HSTS_INCLUDE_SUBDOMAINS = os_environ.get('SECURE_HSTS_INCLUDE_SUBDOMAINS', '1') == '1'
